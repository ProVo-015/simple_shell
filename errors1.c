...
/**
 * print_error - an error message will be prints
 * @info: return info struct and the parameter
 * @estr: string containing indicated error type
...
/**
 * print_d - function will prints a decimal (integer) number (base 10)
 * @input: the input
 * @fd: the filedescriptor to write to
 *
 * Return: it print number of characters
 */
...
/**
 * remove_comments - function substitute’s first case of '#' with '\0'
